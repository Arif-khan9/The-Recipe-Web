...
const Meals = () => {
  return (
    ...
    <div className='grid grid-cols-1  md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 place-items-center mt-45'>
        <div className=' group h-90 w-80 mt-9 hover:-translate-y-1 transition-transform duration-300  shadow-2xl rounded-2xl'>
            <img className='h-65 group-hover:scale-102 object-cover  rounded-t-2xl w-80' src="bread.jpg" alt="" />
          <span className='px-4 w-31 py-1.5 bg-amber-500 text-white rounded-full relative bottom-12 left-2 hidden  group-hover:block'>View Recipe</span>
            <div className='flex flex-col gap-3 group-hover:bottom-9 relative '>
              <h3 className='text-xl font-bold px-5 mt-3'>15-minute chicken & hall..</h3>
